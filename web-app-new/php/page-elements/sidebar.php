<div class="sidebar">
    ...
    <nav>
        ...
        <a href="" id="nav-item-social"><i class="fa fa-users fa-fw"></i>&nbsp;Social</a>
        <a href="" id="nav-item-challenges"><i class="fa fa-calendar-check-o fa-fw"></i>&nbsp;Challenges</a>
        ...
        <a href="" id="nav-item-settings"><i class="fa fa-cog fa-fw"></i>&nbsp;Settings</a>
