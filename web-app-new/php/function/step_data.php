			...
			if($time=="00")
				{
					...
					if($hour_graph_step_row['user_gender']=="Male")
					{
						...
						$MET = 2;
						$hour_graph_cal = round(($BMR/24)*$MET*($hour_graph_step_row['session_time_length']/60));
			...
			else if ($time=="13") 
				{
					...
					else
					{
						$BMR = 655 + (13.75 * $hour_graph_step_row['user_weight']) + (5 * $hour_graph_step_row['user_height']) - (6.76 * (date("Y") - date("Y",strtotime($hour_graph_step_row['user_day_of_birth']))));
						$MET = 2;
						$hour_graph_cal_display[13] = round(($BMR/24)*$MET*($hour_graph_step_row['session_time_length']/60));
						$hour_graph_cal_display[13] = $hour_graph_cal + $hour_graph_cal_display[13];
					}
				}
			else if ($time=="14") 
			...
			if($date=="Mon")
				{
					...
					if($week_graph_step_row['user_gender']=="Male")
					{
						...
						$MET = 2;
						$mon_cal = round(($BMR/24)*$MET*($week_graph_step_row['session_time_length']/60));
			...
			else if ($date=="Tue") 
				{
					...
					if($week_graph_step_row['user_gender']=="Male")
					{
						$BMR = 66 + (13.75 * $week_graph_step_row['user_weight']) + (5 * $week_graph_step_row['user_height']) - (6.76 * (date("Y") - date("Y",strtotime($week_graph_step_row['user_day_of_birth']))));
						$MET = 2;
						$tue_cal = round(($BMR/24)*$MET*($week_graph_step_row['session_time_length']/60));
			...
			else if ($date=="Wed") 
				{
					...
					if($week_graph_step_row['user_gender']=="Male")
					{
						$BMR = 66 + (13.75 * $week_graph_step_row['user_weight']) + (5 * $week_graph_step_row['user_height']) - (6.76 * (date("Y") - date("Y",strtotime($week_graph_step_row['user_day_of_birth']))));
						$MET = 2;
						$wed_cal = round(($BMR/24)*$MET*($week_graph_step_row['session_time_length']/60));
			...
			else if ($date=="Thu") 
				{
					...
					if($week_graph_step_row['user_gender']=="Male")
					{
						$BMR = 66 + (13.75 * $week_graph_step_row['user_weight']) + (5 * $week_graph_step_row['user_height']) - (6.76 * (date("Y") - date("Y",strtotime($week_graph_step_row['user_day_of_birth']))));
						$MET = 2;
						$thu_cal = round(($BMR/24)*$MET*($week_graph_step_row['session_time_length']/60));
			...
			else if ($date=="Fri") 
				{
					...
					if($week_graph_step_row['user_gender']=="Male")
					{
						$BMR = 66 + (13.75 * $week_graph_step_row['user_weight']) + (5 * $week_graph_step_row['user_height']) - (6.76 * (date("Y") - date("Y",strtotime($week_graph_step_row['user_day_of_birth']))));
						$MET = 2;
						$fri_cal = round(($BMR/24)*$MET*($week_graph_step_row['session_time_length']/60));
			...
			else if ($date=="Sat") 
				{
					...
					if($week_graph_step_row['user_gender']=="Male")
					{
						$BMR = 66 + (13.75 * $week_graph_step_row['user_weight']) + (5 * $week_graph_step_row['user_height']) - (6.76 * (date("Y") - date("Y",strtotime($week_graph_step_row['user_day_of_birth']))));
						$MET = 2;
						$sat_cal = round(($BMR/24)*$MET*($week_graph_step_row['session_time_length']/60));
			...
			else if ($date=="Sun") 
				{
					...
					if($week_graph_step_row['user_gender']=="Male")
					{
						$BMR = 66 + (13.75 * $week_graph_step_row['user_weight']) + (5 * $week_graph_step_row['user_height']) - (6.76 * (date("Y") - date("Y",strtotime($week_graph_step_row['user_day_of_birth']))));
						$MET = 2;
						$sun_cal = round(($BMR/24)*$MET*($week_graph_step_row['session_time_length']/60));
    ...
    // Store and calculate total monthly step and cal into array 	
	    while($month_graph_step_row = mysqli_fetch_array($month_graph_step_data, MYSQLI_BOTH))
		{
			...
			if($month_graph_step_row['user_gender']=="Male")
			{
				...
				$MET = 2;
				$month_graph_cal = round(($BMR/24)*$MET*($month_graph_step_row['session_time_length']/60));
		...
		if($total_row['user_gender']=="Male")
			{
				...
				$MET = 2;
				$calories = round(($BMR/24)*$MET*($total_row['session_time_length']/60));
		...
		if($friend_total_row['user_gender']=="Male")
			{
				...
				$MET = 2;
				$friend_calories = round(($BMR/24)*$MET*($friend_total_row['session_time_length']/60));
		...
		if($day_row['user_gender']=="Male")
			{
				...
				$MET = 2;
				$total_day_calories = round(($BMR/24)*$MET*($day_row['session_time_length']/60));
		...
		if($week_row['user_gender']=="Male")
			{
				...
				$MET = 2;
				$total_week_calories = round(($BMR/24)*$MET*($week_row['session_time_length']/60));
		...
		if($month_row['user_gender']=="Male")
			{
				...
				$MET = 2;
				$total_month_calories = round(($BMR/24)*$MET*($month_row['session_time_length']/60));
			...
			if($time=="00")
				{
					...
					if($friend_hour_graph_step_row['user_gender']=="Male")
					{
						...
						$MET = 2;
						$friend_hour_graph_cal = round(($BMR/24)*$MET*($friend_hour_graph_step_row['session_time_length']/60));
			...
			if($date=="Mon")
				{
					...
					if($friend_week_graph_step_row['user_gender']=="Male")
					{
						...
						$MET = 2;
						$friend_mon_cal = round(($BMR/24)*$MET*($friend_week_graph_step_row['session_time_length']/60));
			...
			else if ($date=="Tue") 
				{
					...
					if($friend_week_graph_step_row['user_gender']=="Male")
					{
						$BMR = 66 + (13.75 * $friend_week_graph_step_row['user_weight']) + (5 * $friend_week_graph_step_row['user_height']) - (6.76 * (date("Y") - date("Y",strtotime($friend_week_graph_step_row['user_day_of_birth']))));
						$MET = 2;
						$friend_tue_cal = round(($BMR/24)*$MET*($friend_week_graph_step_row['session_time_length']/60));
			...
			else if ($date=="Wed") 
				{
					...
					if($friend_week_graph_step_row['user_gender']=="Male")
					{
						$BMR = 66 + (13.75 * $friend_week_graph_step_row['user_weight']) + (5 * $friend_week_graph_step_row['user_height']) - (6.76 * (date("Y") - date("Y",strtotime($friend_week_graph_step_row['user_day_of_birth']))));
						$MET = 2;
						$friend_wed_cal = round(($BMR/24)*$MET*($friend_week_graph_step_row['session_time_length']/60));
			...
			else if ($date=="Thu") 
				{
					...
					if($friend_week_graph_step_row['user_gender']=="Male")
					{
						$BMR = 66 + (13.75 * $friend_week_graph_step_row['user_weight']) + (5 * $friend_week_graph_step_row['user_height']) - (6.76 * (date("Y") - date("Y",strtotime($friend_week_graph_step_row['user_day_of_birth']))));
						$MET = 2;
						$friend_thu_cal = round(($BMR/24)*$MET*($friend_week_graph_step_row['session_time_length']/60));
			...
			else if ($date=="Fri") 
				{
					...
					if($friend_week_graph_step_row['user_gender']=="Male")
					{
						$BMR = 66 + (13.75 * $friend_week_graph_step_row['user_weight']) + (5 * $friend_week_graph_step_row['user_height']) - (6.76 * (date("Y") - date("Y",strtotime($friend_week_graph_step_row['user_day_of_birth']))));
						$MET = 2;
						$friend_fri_cal = round(($BMR/24)*$MET*($friend_week_graph_step_row['session_time_length']/60));
			...
			else if ($date=="Sat") 
				{
					...
					if($friend_week_graph_step_row['user_gender']=="Male")
					{
						$BMR = 66 + (13.75 * $friend_week_graph_step_row['user_weight']) + (5 * $friend_week_graph_step_row['user_height']) - (6.76 * (date("Y") - date("Y",strtotime($friend_week_graph_step_row['user_day_of_birth']))));
						$MET = 2;
						$friend_sat_cal = round(($BMR/24)*$MET*($friend_week_graph_step_row['session_time_length']/60));
			...
			else if ($date=="Sun") 
				{
					...
					if($friend_week_graph_step_row['user_gender']=="Male")
					{
						$BMR = 66 + (13.75 * $friend_week_graph_step_row['user_weight']) + (5 * $friend_week_graph_step_row['user_height']) - (6.76 * (date("Y") - date("Y",strtotime($friend_week_graph_step_row['user_day_of_birth']))));
						$MET = 2;
						$friend_sun_cal = round(($BMR/24)*$MET*($friend_week_graph_step_row['session_time_length']/60));
    ...
    // Store and calculate friend total monthly step and cal into array 	
	    while($friend_month_graph_step_row = mysqli_fetch_array($friend_month_graph_step_data, MYSQLI_BOTH))
		{
			...
			if($friend_month_graph_step_row['user_gender']=="Male")
			{
				...
				$MET = 2;
				$friend_month_graph_cal = round(($BMR/24)*$MET*($friend_month_graph_step_row['session_time_length']/60));
