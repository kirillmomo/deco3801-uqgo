...
<html lang="en">
  <head>
    ...
    include($_SERVER['DOCUMENT_ROOT'].'/v0-4/php/page-elements/header.php');
    ?>
  ...
  include($_SERVER['DOCUMENT_ROOT'].'/v0-4/php/page-elements/sidebar.php');
  include($_SERVER['DOCUMENT_ROOT'].'/v0-4/php/page-elements/notification-tray.php');
  ?>
    <div class="content">
        <h1>Dashboard</h1>
        <nav>
